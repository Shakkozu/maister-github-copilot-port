...
**ACTION REQUIRED**: Call the Skill tool with skill="ai-sdlc:research-orchestrator" NOW. Pass all arguments. Do not read files, explore code, or enter plan mode first.
