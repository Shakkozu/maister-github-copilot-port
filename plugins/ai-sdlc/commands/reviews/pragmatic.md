...
**ACTION REQUIRED**: Call the Task tool with subagent_type="ai-sdlc:code-quality-pragmatist" NOW. Pass the path to analyze in the prompt. Do not read files, explore code, or enter plan mode first.
